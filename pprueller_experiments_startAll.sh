...
# sleep 60
# python -m galileoexperimentsextensions.maskdetection.scenario.scenario pruellerpaul edgerun/maskdetection:1.1.0 3 eb-k3s-master maskdetection-3-zones-2x2-avg data/profiles/new_york_2x2_1x1_avg https://i.imgur.com/LpfkZ4D.jpg
# sleep 60
...
# sleepdetection new_york_2x2_2x1 (DONE)
...
# python -m galileoexperimentsextensions.objectdetection.scenario.scenario pruellerpaul edgerun/objectdetection:1.1.0 1 eb-k3s-master objectdetection-1-zone-1x1-min data/profiles/new_york_1x1_1x1_min https://i.imgur.com/LpfkZ4D.jpg
# sleep 60
# python -m galileoexperimentsextensions.objectdetection.scenario.scenario pruellerpaul edgerun/objectdetection:1.1.0 1 eb-k3s-master objectdetection-1-zone-1x1-avg data/profiles/new_york_1x1_1x1_avg https://i.imgur.com/LpfkZ4D.jpg
# sleep 60
# python -m galileoexperimentsextensions.objectdetection.scenario.scenario pruellerpaul edgerun/objectdetection:1.1.0 1 eb-k3s-master objectdetection-1-zone-1x1-max data/profiles/new_york_1x1_1x1_max https://i.imgur.com/LpfkZ4D.jpg
# sleep 60
