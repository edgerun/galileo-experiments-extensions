...
from galileo.shell.shell import Galileo, init
...
from galileoexperimentsextensions.mobilenet.k8s import mobilenet_pod_factory
from galileoexperimentsextensions.mobilenet.util import spawn_client_group, spawn_zone_group
