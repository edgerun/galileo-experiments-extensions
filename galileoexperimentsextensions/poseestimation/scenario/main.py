...
def main():
    ...
    creator = 'test'
    poseestimation_image = 'edgerun/poseestimation:1.0.0'
    app_names = {
        poseestimation_image: 'poseestimation'
    }
    ...
    profiling_apps = {
        poseestimation_image: PoseEstimationProfilingApplication()
    }
    ...
    profiles = {
        'test-zone': {
            poseestimation_image: [test_profile, test_profile]
        }
    }
