...
def main():
    ...
    # Configure Sleepdetection specific parameters (i.e., image_url) and define the function name
    params = {
        'service': {
            'name': 'sleepdetection',
    ...
    sleepdetection_profiling_app = SleepDetectionProfilingApplication()

    workload_config = ProfilingWorkloadConfiguration(
        creator=creator,
        app_name='sleepdetection',
        host=host,
        image=image,
        ...
        context=g,
        params=params,
        profiling_app=sleepdetection_profiling_app,
        no_pods=1,
        n=10,
        ia=0.5,
        n_clients=1
