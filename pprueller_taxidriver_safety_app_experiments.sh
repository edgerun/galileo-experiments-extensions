...
python -m galileoexperimentsextensions.taxidriversafetyapp.scenario.scenario pruellerpaul 2 eb-k3s-master taxidriversafetyapp-2-zones-min data/profiles/new_york_2x2_2x1_min https://i.imgur.com/CubSR2U.jpg
sleep 60
